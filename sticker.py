...
# فونت فارسی/عربی برای متن Persian
FONT_PERSIAN = "/usr/share/fonts/truetype/noto/NotoNaskhArabic-Regular.ttf"
FONT_PERSIAN_BOLD = "/usr/share/fonts/truetype/noto/NotoNaskhArabic-Bold.ttf"
...
def create_image(slot: str) -> bytes:
    ...
    font_big = ImageFont.truetype(FONT_PERSIAN_BOLD, 72)
